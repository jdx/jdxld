// Test that jdxld doesn't panic when doing a relocatable link with an object
// containing .note.gnu.property section (which has $d mapping symbol).
// Previously jdxld panicked with "Tried to copy a symbol in a section we didn't load"
