...
// .text, while GNU ld and jdxld places it before. For this reason, we put stuff in middle.c with
// 128 MiB of padding on either side. That way it doesn't matter which side the PLT is placed on,
// we'll need a thunk to branch to it.
