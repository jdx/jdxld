...
// while jdxld uses separate RO/RX/RW segments.
//#DiffIgnore:segment.LOAD.RWX.alignment
//#DiffIgnore:segment.LOAD.RX.alignment
// jdxld uses alignment 1 for .text when the linker script doesn't specify it;
...
// Config 2: -Ttext/-Tdata/-Tbss overrides. Both jdxld and GNU ld honor these
