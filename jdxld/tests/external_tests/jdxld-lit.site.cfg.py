...
FAKES_DIR = os.environ.get("JDXLD_FAKES_DIR", "")

if not FAKES_DIR:
    raise Exception("JDXLD_FAKES_DIR must be set. Run tests via cargo test.")
...
LIT_CFG = os.environ.get("JDXLD_LIT_CFG", os.path.join(os.path.dirname(__file__), 'lit.cfg.py'))
