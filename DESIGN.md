...
This document provides a high level overview of jdxld's design. The intent is to not go into too much
...
also LLD. It links them with jdxld and compares the resulting binaries using our own custom diff
