...
fn setup_argument_parser() -> ArgumentParser<ElfArgs> {
    ...
    parser
        ...
        .execute(|_args, _modifier_stack| {
            ...
            writeln!(stdout, "jdxld: supported targets: {SUPPORTED_TARGETS}")?;
            writeln!(
                stdout,
                "jdxld: supported emulations: {SUPPORTED_EMULATIONS}"
            )?;
    ...
    parser
        .declare()
        .long("jdxld-experimental-sframe")
