...
This crate allows the jdxld linker to be used as a library. The API is currently fairly narrow and is
...
For more details about the jdxld linker, see the [jdxld
repository](https://github.com/jdx/jdxld).
